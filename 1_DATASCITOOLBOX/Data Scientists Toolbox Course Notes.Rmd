...
## Markdown
* Extension  `.md` denotes markdown file
...
* To Choose R Mirror  'chooseCRANmirror()`
...
* Bioconductor Packages:
    ...
    *  `biocLite(c("GenomicFeatures", "AnnotationDbi"))` = = install multiple package
* `library(packagename)` = load package - Package not in quoates
